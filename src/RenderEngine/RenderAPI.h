...
namespace CRAB
{
    ...
    int main()
    {
        ...
        // TERRENO TESTE
        {
            ...
            terrain_profile.push_back(new VerSegment(VP1, VP2));
            terrain_profile.push_back(new VerSegment(VP2, VP3, VP4));
            terrain_profile.push_back(new VerSegment(VP4, VP5));
            terrain_profile.push_back(new VerSegment(VP5, VP6, VP7));
            terrain_profile.push_back(new VerSegment(VP7, VP8));
            terrain_profile.push_back(new VerSegment(VP8, VP9, VP10));
            terrain_profile.push_back(new VerSegment(VP10, VP11));
        }
