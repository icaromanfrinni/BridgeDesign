...
namespace CRAB
{
    ...
    // --------------------
        ...
        roadways.back()->AddSegment(new Line(CRAB::Vector4Df{ -200.0f, 0.0f, 0.0f, 1.0f }, CRAB::Vector4Df{ 200.0f, 0.0f, 0.0f, 1.0f }));
        bridges.push_back(new BoxGirder("Rio_Pacoti", roadways.back(), 200.0f, 60.0f, 90.0f));
